 ...
 * Register the widget
 */
add_action('widgets_init', create_function('', 'return register_widget("ACF_Nav_Menu_Widget");'));

/**
 * Class Widget_Better_Starter_Widget
 */
class ACF_Nav_Menu_Widget extends WP_Widget
{
	/** Basic Widget Settings */
	const WIDGET_NAME = "ACF Nav Menu";
	const WIDGET_DESCRIPTION = "Advanced Custom Fields (ACF) 'Nav Menu' widget.";
	...
	function __construct()
	{
		...
		$this->add_field('field_name', 'ACF Field Name:', '', 'text');
